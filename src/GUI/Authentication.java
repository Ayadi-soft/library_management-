...
public class Authentication extends JPanel {
	...
	private void initialize() {
		...
		jLabel1 = new JLabel();
		jLabel1.setBounds(new Rectangle(39, 298, 241, 23));
		jLabel1.setText("the ID of a sutudent is : 2");
		jLabel = new JLabel();
		jLabel.setBounds(new Rectangle(41, 267, 240, 22));
		jLabel.setText("the ID of the Administrator is : 1");
		Label_id = new JLabel();
		Label_id.setBounds(new Rectangle(162, 129, 90, 27));
		...
		Label_title.setBounds(new Rectangle(176, 38, 171, 34));
	...
	private JTextField getId() {
		if (id == null) {
			id = new JTextField();
			id.setBounds(new Rectangle(255, 127, 124, 30));
		}
		return id;
	}
	...
	private JButton getOk() {
		if (ok == null) {
			ok = new JButton();
			ok.setBounds(new Rectangle(157, 201, 110, 31));
			ok.setText("ok");
	...
	private JButton getButton_reset() {
		if (Button_reset == null) {
			...
			Button_reset.setBounds(new Rectangle(277, 201, 105, 32));
