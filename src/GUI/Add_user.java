...
public class Add_user extends JPanel {
	...
	private void initialize() {
		...
		Label_type.setBounds(new Rectangle(71, 273, 64, 22));
		Label_type.setText("Type : ");
		Label_dep = new JLabel();
		Label_dep.setBounds(new Rectangle(73, 244, 85, 24));
		Label_dep.setText("Departement :");
		Label_adr = new JLabel();
		Label_adr.setBounds(new Rectangle(72, 209, 58, 25));
		Label_adr.setText("Adress : ");
		Label_tel = new JLabel();
		Label_tel.setBounds(new Rectangle(71, 179, 53, 23));
		Label_tel.setText("Phone Number : ");
		Label_author = new JLabel();
		Label_author.setBounds(new Rectangle(71, 147, 52, 25));
		Label_author.setText("Email : ");
		Label_title = new JLabel();
		Label_title.setBounds(new Rectangle(72, 118, 44, 26));
		Label_title.setText("Name : ");
		Label_isbn = new JLabel();
		Label_isbn.setBounds(new Rectangle(72, 89, 67, 24));
		...
		title = new JLabel();
		title.setBounds(new Rectangle(209, 36, 113, 27));
	...
	private JTextField getIsbn() {
		if (isbn == null) {
			isbn = new JTextField();
			isbn.setBounds(new Rectangle(142, 90, 93, 23));
		}
		return isbn;
	}
	...
	private JTextField getBook_title() {
		if (book_title == null) {
			...
			book_title.setBounds(new Rectangle(142, 120, 111, 26));
		}
		return book_title;
	}
	...
	private JTextField getAuthor() {
		if (author == null) {
			...
			author.setBounds(new Rectangle(142, 150, 127, 25));
		}
		return author;
	}
	...
	private JButton getButton_validate() {
		if (Button_validate == null) {
			...
			Button_validate.setBounds(new Rectangle(317, 310, 88, 32));
	...
	private JButton getButton_reset() {
		if (Button_reset == null) {
			...
			Button_reset.setBounds(new Rectangle(416, 309, 86, 31));
	...
	private JTextField getTextField_phone() {
		if (TextField_phone == null) {
			...
			TextField_phone.setBounds(new Rectangle(142, 182, 103, 23));
		}
	...
	private JTextField getTextField_adr() {
		if (TextField_adr == null) {
			...
			TextField_adr.setBounds(new Rectangle(140, 213, 221, 24));
		}
	...
	private JTextField getTextField_dep() {
		if (TextField_dep == null) {
			...
			TextField_dep.setBounds(new Rectangle(161, 244, 149, 26));
		}
	...
	private JComboBox getComboBox_type() {
		if (ComboBox_type == null) {
			...
			ComboBox_type.setBounds(new Rectangle(142, 274, 119, 23));
...
}  //  @jve:decl-index=0:visual-constraint="65,23"
