...
public class Controle_fines extends JPanel {
	...
	private void initialize() {
		...
		lab_total.setBounds(new Rectangle(448, 305, 67, 29));
		lab_total.setText("");
		Lab_lab = new JLabel();
		Lab_lab.setBounds(new Rectangle(397, 304, 37, 28));
		...
		Label_title.setBounds(new Rectangle(186, 38, 159, 28));
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setBounds(new Rectangle(24, 92, 501, 202));
