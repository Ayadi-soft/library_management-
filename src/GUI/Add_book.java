...
public class Add_book extends JPanel {
	...
	private void initialize() {
		...
		Label_author.setBounds(new Rectangle(70, 186, 52, 25));
		Label_author.setText("Author : ");
		Label_title = new JLabel();
		Label_title.setBounds(new Rectangle(69, 145, 44, 26));
		Label_title.setText("Title : ");
		Label_isbn = new JLabel();
		Label_isbn.setBounds(new Rectangle(67, 98, 43, 24));
		...
		title = new JLabel();
		title.setBounds(new Rectangle(220, 48, 113, 27));
	...
	private JTextField getIsbn() {
		if (isbn == null) {
			isbn = new JTextField();
			isbn.setBounds(new Rectangle(113, 98, 93, 26));
		}
		return isbn;
	}
	...
	private JTextField getBook_title() {
		if (book_title == null) {
			...
			book_title.setBounds(new Rectangle(116, 143, 111, 26));
		}
		return book_title;
	}
	...
	private JTextField getAuthor() {
		if (author == null) {
			...
			author.setBounds(new Rectangle(128, 186, 127, 25));
		}
		return author;
	}
	...
	private JButton getButton_validate() {
		if (Button_validate == null) {
			...
			Button_validate.setBounds(new Rectangle(308, 304, 88, 32));
	...
	private JButton getButton_reset() {
		if (Button_reset == null) {
			...
			Button_reset.setBounds(new Rectangle(407, 303, 86, 31));
